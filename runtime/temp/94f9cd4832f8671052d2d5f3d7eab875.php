<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"./themes/default/index/index.html";i:1482475951;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
      ...
      <div role="listbox" class="carousel-inner">
        ...
        ->order("a.createtime")->select();if(is_array($__BANNER__) || $__BANNER__ instanceof \think\Collection): if( count($__BANNER__)==0 ) : echo "" ;else: foreach($__BANNER__ as $key=>$banner): ?>
			<div class="item <?php if($key == '0'): ?>active<?php endif; ?>">
				<a href="<?php echo url($banner['link']); ?>"><img alt="title" src="<?php echo root_path(); ?><?php echo $banner['banner_path']; ?>" width="<?php echo $banner['width']; ?>" height="<?php echo $banner['height']; ?>" data-holder-rendered="true"></a>
			</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
      </div>
	...
	<div class="main-left">
        ...
        <div class="about-box">
        	...
        	<div class="about-text">
				<?php $__PAGES__ = db('posts')->field(true)->where("id=15")->where('type','page')->order("level")->select();if(is_array($__PAGES__) || $__PAGES__ instanceof \think\Collection): $i = 0; $__LIST__ = $__PAGES__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$page): $mod = ($i % 2 );++$i;?>
				<a href="<?php echo url('index/article/page','name=company'); ?>">
		...
		<div id="myTabContent" class="tab-content">
   			<div class="tab-pane fade in active" id="hot">
                ...
                <div class="hpp-box-more">
                	<a href="<?php echo url('index/goods/lists'); ?>">查看更多>></a>
                </div>
   			</div>
