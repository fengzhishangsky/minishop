<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:56:"E:\www\minishop1/application/admin\view\theme\index.html";i:1482466099;s:56:"E:\www\minishop1/application/admin\view\common\head.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\header.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\navbar.html";i:1477622208;s:58:"E:\www\minishop1/application/admin\view\common\footer.html";i:1482462992;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="pull-left" style="margin-top:5px;"> <button  type="button" name="<?php echo $vo; ?>" class="btn btn-block btn-primary btn-xs ">应用</button></div><div style="padding-top:5px;margin-left:180px;"><span class="label label-success" >已应用</span></div>
              </div>
              </div>
              <?php else: ?>
              <div class="col-lg-3 col-md-4 col-ms-4 col-xs-6 bg">
