<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"./themes/default/index/news_detail.html";i:1482475828;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="main">
    ...
    <div class="red">
      ...
      <?php if(is_array(get_self_category($categoryInfo['pid'])) || get_self_category($categoryInfo['pid']) instanceof \think\Collection): $k = 0; $__LIST__ = get_self_category($categoryInfo['pid']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;if($k == '1'): if($categoryInfo['name'] == $data['name']): ?>
          ...
          <?php endif; else: if($categoryInfo['name'] == $data['name']): ?>
            <span>|</span></p><p><a href="<?php echo url('Article/lists?category='.$data['slug']); ?>" style="color:#FF2D4B"><?php echo $data['name']; ?></a>
          <?php else: ?>
            <span>|</span></p><p><a href="<?php echo url('Article/lists?category='.$data['slug']); ?>"><?php echo $data['name']; ?></a>
          <?php endif; endif; endforeach; endif; else: echo "" ;endif; ?>
      </p>
    </div>
    <div style="float:right"><a href="<?php echo url('Index/index'); ?>">首页</a> / <a href="<?php echo url('Article/lists?category='.$categoryInfo['slug']); ?>"><?php echo $categoryInfo['name']; ?></a> / 详情</div>
    </div>
  ...
  <div class="bottom">
    <p>上一篇 : <span><?php echo get_pre($postInfo['id'],$categoryInfo['id']); ?></span></p>
    <p>下一篇 : <span><?php echo get_next($postInfo['id'],$categoryInfo['id']); ?></span></p>
  </div>
</div>
</div>
<!--main end-->
