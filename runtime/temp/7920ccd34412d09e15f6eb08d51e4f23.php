<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"E:\www\minishop1/application/admin\view\navigation\index.html";i:1482462992;s:56:"E:\www\minishop1/application/admin\view\common\head.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\header.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\navbar.html";i:1477622208;s:58:"E:\www\minishop1/application/admin\view\common\footer.html";i:1482462992;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/navigation/index'); ?>">设置</a></li>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="pull-left" style="margin-left:15px;">
                <a href="<?php echo url('add'); ?>" class="btn btn-block btn-primary btn-sm">添加导航</a>
              </div>
            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                        <?php echo tree_to_nav_view($navigationListTree); ?>
                  </tbody>
                  <thead>
                  <tr>
                    <th><input type="checkbox" class="selectAll"></th>
