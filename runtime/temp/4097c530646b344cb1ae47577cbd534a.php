<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./themes/default/index/goods_list.html";i:1482462992;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
            ...
            <?php if($type == '1'): if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                <div class="col-md-3 box-style">
                	<div class="goods-item">
                        ...
                        <span class="line2"><span class="standard">规格：<?php echo $data['standard']; ?></span><span style="float:right;color:#FE0000;font-weight:bold;">
                        <?php if(!(empty($data['score']) || ($data['score'] instanceof \think\Collection && $data['score']->isEmpty()))): ?>
                        赠积分<?php echo $data['score']; endif; ?>
                        </span></span>
                        ...
                        <div class="line-style-right">
                            ...
                            <div style="width:610px; float:left; height:40px;">
                                <div style="float:left; color:#ff2c4c; font-size:16px; margin-top:20px;">
                                    <img src="<?php echo config('theme_path'); ?>/index/images/sales_heat_big.png"> 总销量:<?php echo $data['sell_num']; ?><span style="margin-left:20px">
                                        <?php if(!(empty($data['score']) || ($data['score'] instanceof \think\Collection && $data['score']->isEmpty()))): ?>
                                        赠积分<?php echo $data['score']; endif; ?>
                                    </span>
                                </div>
