<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"E:\www\minishop1/application/admin\view\apiconfig\edit.html";i:1482472572;s:56:"E:\www\minishop1/application/admin\view\common\head.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\header.html";i:1482462992;s:58:"E:\www\minishop1/application/admin\view\common\navbar.html";i:1477622208;s:58:"E:\www\minishop1/application/admin\view\common\footer.html";i:1482462992;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
              ...
              <form  method="post" enctype="multipart/form-data" id='form'>
                <div class="box-body">
                  <?php if(is_array($list) || $list instanceof \think\Collection): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;switch($k): case "1": ?>
                        <h4 style="color:#3c8dbc;padding:3px;">小票打印机接口</h4>
                      <?php break; case "8": ?>
                        <h4 style="color:#3c8dbc;padding:3px;">发送短信接口</h4>
                      <?php break; case "12": ?>
                        <h4 style="color:#3c8dbc;padding:3px;">支付宝接口</h4>
                      <?php break; case "14": ?>
                        <h4 style="color:#3c8dbc;padding:3px;">微信支付接口</h4>
                      <?php break; case "19": ?>
                        <h4 style="color:#3c8dbc;padding:3px;">百度地图接口</h4>
